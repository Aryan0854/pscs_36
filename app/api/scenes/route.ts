...
const scenes: Scene[] = [
  {
    ...
    status: "ready",
    assets: [
      { id: "asset-1", type: "image", name: "Background", url: "/assets/background.png" },
      { id: "asset-2", type: "text", name: "Title", url: "" },
    ],
    settings: {
  ...
  },
  {
    ...
    projectId: "1",
    title: "Main Content",
    description: "Key information and data",
    template: "content",
    duration: 45,
    language: "English",
    status: "ready",
    assets: [
      ...
      { id: "asset-4", type: "text", name: "Data Points", url: "" },
    ],
    settings: {
