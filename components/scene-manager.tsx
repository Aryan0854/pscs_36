...
export function SceneManager() {
  const [scenes, setScenes] = useState<Scene[]>([
    ...
    },
    {
      ...
      status: "processing",
      assets: [
        { id: "asset-3", type: "image", name: "Chart Background", url: "/assets/chart-bg.png" },
        { id: "asset-4", type: "text", name: "Statistics Data", url: "" },
      ],
      settings: {
  ...
  const sceneTemplates: SceneTemplate[] = [
    {
      ...
      description: "Professional opening with logo and title",
      preview: "/templates/gov-intro.jpg",
      category: "Introduction",
    },
    {
      id: "data-visualization",
      name: "Data Visualization",
      description: "Charts, graphs, and statistical displays",
      preview: "/templates/data-viz.jpg",
      category: "Data",
    },
    {
      id: "policy-highlight",
      name: "Policy Highlight",
      description: "Key policy points with emphasis",
      preview: "/templates/policy.jpg",
      category: "Content",
    },
    {
      id: "conclusion",
  ...
  return (
    <div className="h-[700px] w-full flex bg-background">
      {/* Scene List */}
                  ...
                  <div className="flex-1 flex">
                    ...
                    <div className="w-80 border-l bg-card">
                      <Tabs defaultValue="properties" className="h-full flex flex-col">
                        ...
                        <TabsContent value="assets" className="flex-1 p-4 space-y-4">
                          <div className="flex items-center justify-between">
